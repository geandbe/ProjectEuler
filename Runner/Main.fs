...
module Runner =
    ...
    let problems : (unit -> obj option) array =
        [|
            ...
            omit; //Problem075.problem075 >> wrap;
            ...
            omit; //Problem080.problem080 >> wrap;
            omit; //Problem081.problem081 >> wrap;
            omit; //Problem082.problem082 >> wrap;
            omit; //Problem083.problem083 >> wrap;
            omit; //Problem084.problem084 >> wrap;
            omit; //Problem085.problem085 >> wrap;
            omit; //Problem086.problem086 >> wrap;
            omit; //Problem087.problem087 >> wrap;
            omit; //Problem088.problem088 >> wrap;
            omit; //Problem089.problem089 >> wrap;
            Problem090.problem090 >> wrap;
